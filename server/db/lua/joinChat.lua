...
redis.call('hset', 'chat:' .. data.key.keyId .. ':user:' .. data.user.uid, 'pokemon', data.user.pokemon, 'uid', data.user.uid, 'joined', data.user.joinedAt)

redis.call('hset', 'socket:' .. data.socket, 'uid', data.user.uid, 'key', data.key.keyId)
