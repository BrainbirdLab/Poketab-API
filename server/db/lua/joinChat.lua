...
--]]
redis.call('hset', 'chat:' .. data.key.keyId .. ':user:' .. data.user.uid, 'name', data.user.name, 'avatar', data.user.avatar, 'uid', data.user.uid, 'joined', data.user.joinedAt)
...
--]]
redis.call('hset', 'socket:' .. data.socket, 'name', data.user.name, 'uid', data.user.uid, 'key', data.key.keyId)
